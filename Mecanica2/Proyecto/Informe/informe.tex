...
\begin{figure}[H]
\centering
\subfigure[Sistema Tierra$-$Luna \label{lag t-lj}]{\includegraphics[scale=0.6]{Images/contourTierraLunaLagrange.pdf}}
\subfigure[Sistema Sol$-$Jupiter \label{lag s-j}]{\includegraphics[scale=0.6]{Images/contourSolJupiterLagrange.pdf}}
\subfigure[Sistema Sol$-$Tierra \label{lag s-t}]{\includegraphics[scale=0.6]{Images/contourSolTierraLagrange.pdf}}
